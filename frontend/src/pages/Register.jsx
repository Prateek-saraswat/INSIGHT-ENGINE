...
import { Brain, Mail, Lock, User, ArrowRight, AlertCircle, Sparkles, Eye, EyeOff, Check, X } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const Register = () => {
  const navigate = useNavigate();
  const { register, clearError, isAuthenticated, loading: authLoading } = useAuth();
        ...
        >
          ...
          <div className="text-center mb-8 relative z-10">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 glass-effect rounded-full mb-5 shadow-lg relative overflow-hidden group">
              ...
              <span className="text-sm font-medium text-blue-300 relative z-10">Create Account</span>
            </div>
            <h1 className="text-4xl font-bold text-white mb-3 display-font text-gradient-animated">Sign Up</h1>
            <p className="text-blue-200">Start your research journey today</p>
          </div>
          ...
          {formError && (
            <div className="mb-6 p-4 glass-effect border border-red-400/30 rounded-xl flex items-center gap-3 error-shake relative overflow-hidden">
              ...
              <span className="text-red-300 relative z-10">{formError}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            ...
            <div className="relative">
              ...
              <div className="relative group">
                <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 z-10 ${
                  focusedField === 'username' ? 'text-blue-400 scale-110' : 'text-blue-300/50'
                }`} />
                <input
                  type="text"
                  id="username"
              ...
              {formData.password && (
                <div className="mt-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-semibold text-blue-200">{getStrengthLabel()}</span>
                  </div>
                  <div className="h-2 bg-slate-800/50 rounded-full overflow-hidden">
                    <div 
                      className={`h-full bg-gradient-to-r ${getStrengthColor()} strength-bar rounded-full transition-all duration-300`}
            ...
            <div className="relative">
              ...
              <div className="relative group">
                <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 z-10 ${
                  focusedField === 'confirmPassword' ? 'text-blue-400 scale-110' : 'text-blue-300/50'
                }`} />
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-bold rounded-xl shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-500 disabled:opacity-70 button-ripple relative overflow-hidden group mt-6"
            >
